...
<div class="container">
    <h1>编辑新闻</h1>
    <form class="news-form" action="UpdateNewsServlet" method="post">
        <input type="hidden" name="newsId" value="${newsItem.newsId}">

        <label for="title">标题</label>
        <input type="text" id="title" name="title" value="${newsItem.title}" required placeholder="请输入新闻标题">

        <label for="author">作者</label>
        <input type="text" id="author" name="author" value="${newsItem.author}" required placeholder="请输入作者姓名">

        <label for="content">内容</label>
        <textarea id="content" name="content" rows="10" required placeholder="请输入新闻内容">${newsItem.content}</textarea>
