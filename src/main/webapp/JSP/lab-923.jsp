...
<div class="container">
    ...
    <div class="content">
        <h1>923创新实验室</h1>
        <pre>
   923创新实验室成立于2012年7月，是信息与计算机技术实践教学综合性专业化实践教学平台。中心面向全校，主要承担计算机系统类、电子信息类、计算机软件工程实践类、计算机应用技术类、数学软件类、硬件及嵌入式应用网络技术类、信息管理类等的课程的实践教学课程与创新活动。中心地处我校最主要的教学楼，丹青楼的整个9层及成栋楼8层东侧，总建筑面积4150平方米，方便集中式教学和开放管理。
