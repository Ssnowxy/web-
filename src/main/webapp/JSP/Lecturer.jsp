    ...
    <div class="content">
        ...
        <ul>
            <li style="float:left;width:23%;padding:10px 1%">
                <a href="${pageContext.request.contextPath}/JSP/xiaoke.jsp" title="小可 ">
                    <img src="https://img2.baidu.com/it/u=2770398276,1384884292&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=500" style="width:100%; height:230px;border: 1px solid #ccc;">
                    <p style="text-align: center;line-height: 35px;font-size: 16px;"> 小可 </p>
                </a>
            </li>
        </ul>
    </div>
