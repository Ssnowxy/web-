...
<div class="container">
    ...
    <div class="content">
       ...
       <ul>
           ...
           <a href="${pageContext.request.contextPath}/JSP/xiaoying.jsp"title="小樱">
               <img src="https://img2.baidu.com/it/u=175823369,3150537963&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=500" style="width:100%; height:230px;border: 1px solid #ccc;">
               <p style="text-align: center;line-height: 35px;font-size: 16px;"> 小樱</p>
           </a>
           </li>
       </ul>
    </div>
