...
public class UpdateAnnouncementServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String sql = "SELECT * FROM gonggao WHERE news_id = ?";
        News newsItem = null;
        ...
        if (newsItem != null) {
            ...
            req.getRequestDispatcher("/WEB-INF/manage/UpdateAnnouncement.jsp").forward(req, resp);
        } else {
            resp.sendRedirect(req.getContextPath()+"/AdminAnnouncementsServlet");
        }
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String sql = "UPDATE gonggao SET title = ?, author = ?, content = ?, image_path = ? WHERE news_id = ?";
